...
// 패킷헤더.
//
// 패킷사이즈는 리얼 패킷사이즈로 가고, 그 뒤에 앤드코드를 집어넣어서 확인하는 방식으로 가자
//---------------------------------------------------------------
/*
...
#define dfNETWORK_PACKET_TEMP	((BYTE)0x00)

#define	dfPACKET_SC_CREATE_MY_CHARACTER			(BYTE)0
#define dfPACKET_SC_CREATE_MY_CHARACTER_SIZE	(BYTE)10
//---------------------------------------------------------------
