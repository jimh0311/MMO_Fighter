...
template <typename T>
bool myIterator<T>::Swap()
{
	Node<T>* temp1 = pPosition->pPrev;
	Node<T>* temp2 = pPosition;
	if (temp2 == nullptr || temp2->pNext == nullptr)
	{
		return false;
	}
	T tempData = temp1->value;
