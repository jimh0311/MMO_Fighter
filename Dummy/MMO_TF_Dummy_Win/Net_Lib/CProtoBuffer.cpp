...
CProtoBuffer&	CProtoBuffer::operator << (UINT64 iValue)
{
	Enqueue((char*)&iValue, sizeof(UINT64));
	return *this;
}

CProtoBuffer&	CProtoBuffer::operator << (UINT iValue)
{
	Enqueue((char*)&iValue, sizeof(UINT));
	return *this;
}
//////////////////////////////////////////////////////////////////////////
// 빼기.	각 변수 타입마다 모두 만듬.
...
CProtoBuffer&	CProtoBuffer::operator >> (UINT64 &i64Value)
{
	Dequeue((char*)&i64Value, sizeof(UINT64));
	return *this;
}
CProtoBuffer&	CProtoBuffer::operator >> (UINT &i64Value)
{
	Dequeue((char*)&i64Value, sizeof(UINT));
	return *this;
}
